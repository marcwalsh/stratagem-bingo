...
document.addEventListener("DOMContentLoaded", () => {
    const stratagems = [
        "Orbital_Illumination_Flare", "Hellbomb", "Tectonic_Drill", "Seismic_Probe",
        "SEAF_Artillery", "Reinforce", "Prospecting_Drill", "Super_Earth_Flag",
        "Upload_Data", "Dark_Fluid_Vessel", "Resupply", "SOS_Beacon",
        ...
        "Eagle_110MM_Rocket_Pods", "Eagle_Rearm", "Eagle_Airstrike", "Eagle_Smoke_Strike",
        ...
        "Heavy_Machine_Gun", "Anti-Materiel_Rifle", "Spear", "Flamethrower",
        "Stalwart", "Recoilless_Rifle", "Railgun", "Orbital_Airburst_Strike",
        "Orbital_Railcannon_Strike", "Orbital_120MM_HE_Barrage", "Orbital_Walking_Barrage",
        "Orbital_Gatling_Barrage", "Orbital_380MM_HE_Barrage", "Orbital_Laser",
        "Emancipator_Exosuit", "Machine_Gun_Sentry", "Guard_Dog", "Gatling_Sentry",
        "Rocket_Sentry", "Patriot_Exosuit", "Autocannon_Sentry", "Mortar_Sentry",
        "EMS_Mortar_Sentry"
    ];

    const stratagemImages = {
        "Orbital_Illumination_Flare": "./images/General_Stratagems/Orbital_Illumination_Flare.svg",
        "Hellbomb": "./images/General_Stratagems/Hellbomb.svg",
        "Tectonic_Drill": "./images/General_Stratagems/Tectonic_Drill.svg",
        "Seismic_Probe": "./images/General_Stratagems/Seismic_Probe.svg",
        "SEAF_Artillery": "./images/General_Stratagems/SEAF_Artillery.svg",
        "Reinforce": "./images/General_Stratagems/Reinforce.svg",
        "Prospecting_Drill": "./images/General_Stratagems/Prospecting_Drill.svg",
        "Super_Earth_Flag": "./images/General_Stratagems/Super_Earth_Flag.svg",
        "Upload_Data": "./images/General_Stratagems/Upload_Data.svg",
        "Dark_Fluid_Vessel": "./images/General_Stratagems/Dark_Fluid_Vessel.svg",
        "Resupply": "./images/General_Stratagems/Resupply.svg",
        "SOS_Beacon": "./images/General_Stratagems/SOS_Beacon.svg",
        ...
        "Eagle_Rearm": "./images/Hangar/Eagle_Rearm.svg",
...
function printBingoCard() {
    ...
    stratagems.forEach((stratagem, index) => {
        printWindow.document.write(`<div class="bingo-cell"><img src="${stratagemImages[index]}" alt="${stratagem}"></div>`);
    });
